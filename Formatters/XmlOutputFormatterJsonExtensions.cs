...
public static class XmlOutputFormatterJsonExtensions
{
    ...
    /// </summary>
    /// <param name="value">The <see cref="XmlOutputFormatter"/> instance to serialize.</param>
    /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
    /// <returns>A JSON string representation of the <see cref="XmlOutputFormatter"/> instance.</returns>
    ...
    /// <returns>An <see cref="XmlOutputFormatter"/> instance deserialized from JSON.</returns>
    ...
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <param name="value">Receives the deserialized <see cref="XmlOutputFormatter"/> instance if successful.</param>
